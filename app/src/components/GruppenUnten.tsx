...
import { useSitzung, neueId } from '../store/sitzung'
import { useT } from '../lib/useT'
import { Gruppe, Symbolknopf } from './ui/Gruppe'
import { useMeldungen } from './ui/Meldungen'
import { STIL_NAME } from './GruppenOben'
import { setzeStatsZurueck } from '../lib/strom'
import { audio } from '../lib/audio'
import type { Befehl, McpServer, SitzungKurz, StatusBericht } from '../lib/types'
